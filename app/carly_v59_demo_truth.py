"""Carly v59 demo-truth capsule: unknown-make honesty, authoritative price ranges, and buyer-text isolation."""
...
def install(app:Any)->None:
    for route in getattr(app,"routes",[]):
        ...
        def endpoint(*args:Any,__prior=prior,**kwargs:Any):
            ...
            _sanitize_user_context_inplace(body)
            try:
    ...
    log.warning("CARLY_V59 installed unknown_make_guard=true price_floor=true buyer_context_isolation=true ready_search_bypass=true vision_inline_max=%s vision_jit_flag=%s",os.getenv("CARLY_VISION_INLINE_MAX","(default 3)"),os.getenv("CARLY_VISION_JIT_ENABLED","(default 1 = ON)"))
