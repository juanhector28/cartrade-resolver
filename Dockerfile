...
COPY resolver_patch_gt_demo_breadth_v23.py /tmp/resolver_patch_gt_demo_breadth_v23.py
RUN python /tmp/resolver_patch_gt_demo_breadth_v23.py && rm /tmp/resolver_patch_gt_demo_breadth_v23.py
